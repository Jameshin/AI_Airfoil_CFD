...
TC = np.tile(con_star, (Nfoil,1,N)) # Nfoil x T x N
print(DC.shape)
...
TC_star = np.transpose(TC[:,:,idx_x_slice], (0,1,2))
...
#TC_star = TC
###
np.savez("./array_foil_UIUC_cuttail2064_T.npz", TC=TC_star, XC=XC_star, YC=YC_star, DC=DC_star, UC=UC_star, VC=VC_star, PC=PC_star)
### check
